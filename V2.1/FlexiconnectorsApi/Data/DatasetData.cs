    ...
    public class DatasetData
    {
        ...
        public DataTable ClonePipelineDatasetData(ClonePipelineDatasetModel objClonePipelineDatasetModel, UserInfoModel.headerValue headerval, string constring)
        {
            try
            {
                ...
                parameters.Add(dbManager.CreateParameter("in_new_dataset_name", SafeDbValue(objClonePipelineDatasetModel.in_new_dataset_name), DbType.String));
                parameters.Add(dbManager.CreateParameter("in_user_code", SafeDbValue(objClonePipelineDatasetModel.in_new_dataset_name), DbType.String));
                parameters.Add(dbManager.CreateParameter("out_msg", "out", DbType.String, ParameterDirection.Output));
                parameters.Add(dbManager.CreateParameter("out_result", "out", DbType.String, ParameterDirection.Output));
